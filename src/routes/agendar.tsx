  ...
  return (
    <>
      ...
      <div className="agendar-page relative">
        ...
        <a
          href="/"
          className="absolute top-6 left-6 z-50 text-white/90 hover:text-white flex items-center gap-2 text-xs md:text-sm tracking-wider uppercase transition-all bg-white/5 hover:bg-white/15 px-4 py-2 rounded-full border border-white/10 backdrop-blur-sm shadow-sm"
