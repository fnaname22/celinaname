  ...
  return (
    <section className="section-padding bg-primary relative overflow-hidden">
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-20 left-20 w-96 h-96 rounded-full border border-gold" />
        <div className="absolute bottom-20 right-20 w-64 h-64 rounded-full border border-gold" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-primary-foreground/60 text-lg max-w-xl mx-auto">
            O caminho da transformação em 3 passos
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {steps.map((s, i) => (
            <div key={i} className="text-center">
              <div className="relative w-20 h-20 rounded-full bg-gold/10 border-2 border-gold/30 flex items-center justify-center mx-auto mb-6">
                <s.icon size={32} className="text-gold" />
                <span className="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-gold text-primary text-xs font-bold flex items-center justify-center">
                  {s.step}
                </span>
              </div>
